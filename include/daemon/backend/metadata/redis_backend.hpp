...
#ifndef GEKKOFS_METADATA_REDISBACKEND_HPP
#define GEKKOFS_METADATA_REDISBACKEND_HPP
 ...
 */
class RedisBackend : public MetadataBackend<RedisBackend> {
private:
    std::unique_ptr<sw::redis::Redis> rds_db_;

public:
    explicit RedisBackend(const std::string& path, const std::string& redis_server);

    virtual ~RedisBackend();
...
#endif // GEKKOFS_METADATA_REDISBACKEND_HPP
