...
{
	export MPIRUN=
	export LIBUCS=/home/whj/gekkofs/gekkofs/deps/ucx/src/ucs/.libs/libucs.so
	export LIBUCT=/home/whj/gekkofs/gekkofs/deps/ucx/src/uct/.libs/libuct.so
	export LIBUCP=/home/whj/gekkofs/gekkofs/deps/ucx/src/ucp/.libs/libucp.so
	export VERBOSE=0
	export EXE=""
	export EXE_ARGS=""
...
run_open_mpi()
{
	...
	then
		...
		EXE="valgrind \
			...
			--suppressions=/home/whj/gekkofs/gekkofs/deps/ucx/test/mpi/ompi.supp \
			$VALGRIND_ARGS \
			$EXE"
